...
namespace SabberStoneCoreAi.Tyche2
{
	...
	{	
		...
		public static TyState FromSimulatedGame(POGame newState, Controller me, PlayerTask task)
		{
		...
		private static void CorrectHeroPower(TyState lastPlayerState, TyState lastEnemyState, POGame lastState, PlayerTask task, ref bool corrected)
		{
		...
		private static void CorrectMinionAttack(TyState lastPlayerState, TyState lastEnemyState, POGame lastState, PlayerTask task, ref bool corrected)
		{
			if (task.HasSource)
			{
		...
		private static void CorrectTurnEnd(TyState lastPlayerState, TyState lastEnemyState, POGame lastState, PlayerTask task, ref bool corrected)
		{
		...
		private static void CorrectHeroAttack(TyState lastPlayerState, TyState lastEnemyState, POGame lastState, PlayerTask playerTask, ref bool corrected)
		{
		...
		private static void CorrectPlayCard(TyState lastPlayerState, TyState lastEnemyState, POGame lastState, PlayerTask task, ref bool corrected)
		{	
			if(task.HasSource)
			{
