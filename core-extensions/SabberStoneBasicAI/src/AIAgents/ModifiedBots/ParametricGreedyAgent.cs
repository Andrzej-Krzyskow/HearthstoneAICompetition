...
namespace SabberStoneBasicAI.AIAgents
{
	class ParametricGreedyAgent : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("0.2931452346952785#1#0.04203036489572484#0.27988798138203397#0.6342810678606312#0.7919706182219035#0.9998024899992419#0.0576432311755789#0.8887270519171586#1#0#0#0#0#1#0#1#1#0#0.20124324596271537#0.7370967823755463");
		}
