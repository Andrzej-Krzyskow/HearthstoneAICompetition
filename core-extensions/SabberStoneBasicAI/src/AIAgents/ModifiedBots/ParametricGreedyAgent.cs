...
namespace SabberStoneBasicAI.AIAgents
{
	class ParametricGreedyAgent : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("0.5694607127432296#0.9581118200406723#0.06894924670965147#0#0.8435739872192565#0.7002254236879103#0.9076803534408692#0#0.993682660717062#1#0.6407539495113544#0.9928725123384147#0.9287003687499841#0.1681004843220778#0.8700801074537183#0#0.4289776280804476#1#0#0.583884736645886#0");
		}
