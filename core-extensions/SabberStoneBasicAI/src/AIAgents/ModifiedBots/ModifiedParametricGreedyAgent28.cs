...
namespace SabberStoneBasicAI.AIAgents
{
	class ModifiedParametricGreedyAgent28 : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("0.6404890956681666#0.9868737276869936#0.08804778933294624#0.17081919173198562#0.6305455910248359#0.6806222204069909#0.734677015709144#0.23287243068651786#0.8929334214082597#1#0.27638477367461506#0#1#0#1#0.7650083556372747#0#1#0#0.5699853624090795#0.3231065265869872#1#1#0#0.9751456832124314#0#0.14861785319824866#0.6015078979303822");
