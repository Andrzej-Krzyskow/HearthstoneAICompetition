...
namespace SabberStoneBasicAI.AIAgents
{
	class ModifiedParametricGreedyAgent28 : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("0.9622560353455828#1#0#0#1#1#1#0#0.86147339157364#1#0.5430266096979701#1#0#0.17621606443353027#1#0.4104209220994927#0.9374832102214393#1#0.29276559472066643#0.01825896895584212#0.28901297450699664#0.6247405241351475#0#0.2299751081125314#0.7157675822536926#0.44551237594442145#0.7088354719260018#1");
