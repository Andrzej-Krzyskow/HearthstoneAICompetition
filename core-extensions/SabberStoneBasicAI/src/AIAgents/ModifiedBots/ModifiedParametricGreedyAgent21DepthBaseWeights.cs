...
{
	class ModifiedParametricGreedyAgent21DepthBaseWeights : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("0.464811721#0.957010141#0.040338326#0.67701262#0.332088314#0.599264904#0#0#1#1#1#0.091104966#0.684484708#0.369738304#0.323052802#1#0.193644695#1#0.249525823#0.350936521#1");
