...
namespace SabberStoneBasicAI.AIAgents
{
	class ModifiedParametricGreedyAgent21Depth : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("0.6370144361645688#0.8693729993417707#0.04145355798952109#0#0.5284833769975839#1#1#0.24843954603017138#0.9633740877051998#0.9628277206453657#0#1#0#1#0#0.8111120299612977#0.6856441765661347#0.7033843393790006#0#0.20750291750147026#0.3432948003165308");
