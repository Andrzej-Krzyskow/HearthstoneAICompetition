...
namespace SabberStoneBasicAI.AIAgents
{
	class ModifiedParametricGreedyAgent28Normalaized : AbstractAgent
	{
		...
		public override void InitializeAgent()
		{
			...
			setAgeintWeightsFromString("1#0.6170494037371308#0.8959519467352431#1#1#1#0#0#0.9637936106468138#1#0.5259864598374802#0#0.582902554578242#0.721701175457687#1#0.9181312693793902#0#0.018158256642722043#0#0.901735906637875#1#0.3709088625749877#0#0#0.35149468141469903#0.7365861105765011#0.07727582249331019#0");
